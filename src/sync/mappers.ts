...
export function kanjiToRemote(kanji: Kanji, ownerId: string, version: number) {
  return {
    ...
    meaning_mnemonic: kanji.meaningMnemonic ?? null,
    meaning_hint: kanji.meaningHint ?? null,
    reading_mnemonic: kanji.readingMnemonic ?? null,
    reading_hint: kanji.readingHint ?? null,
...
export function remoteToKanji(row: Record<string, unknown>): Kanji {
  return {
    ...
    notes: (row.notes as string | null) ?? undefined,
    meaningMnemonic: (row.meaning_mnemonic as string | null) ?? undefined,
    meaningHint: (row.meaning_hint as string | null) ?? undefined,
    readingMnemonic: (row.reading_mnemonic as string | null) ?? undefined,
    readingHint: (row.reading_hint as string | null) ?? undefined,
    externalId: (row.external_id as string | null) ?? undefined,
    createdAt: String(row.created_at),
    updatedAt: String(row.updated_at),
  };
